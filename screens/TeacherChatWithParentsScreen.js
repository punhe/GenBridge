...
const chatData = [
  {
    id: "1",
    message: "Chào cô giáo, tôi muốn hỏi về tiến độ học của con.",
    sender: "phụ huynh",
  },
  {
    id: "2",
    message:
      "Chào anh/chị, con đang có tiến bộ trong môn Toán nhưng cần cố gắng thêm ở môn Văn.",
    sender: "giáo viên",
  },
  {
    id: "3",
    message: "Vậy tôi có thể hỗ trợ con bằng cách nào ạ?",
    sender: "phụ huynh",
  },
  {
    id: "4",
    message:
      "Anh/chị có thể giúp con luyện thêm các bài đọc hiểu và viết luận vào cuối tuần.",
    sender: "giáo viên",
  },
];
...
export default function TeacherChatWithParentsScreen() {
  ...
  const sendMessage = () => {
    if (message.trim()) {
      setChat([
        ...chat,
        { id: `${chat.length + 1}`, message, sender: "giáo viên" },
      ]);
      setMessage("");
    }
  };
